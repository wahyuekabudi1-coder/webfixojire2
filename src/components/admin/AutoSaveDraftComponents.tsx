...
export function useAutoSaveDraft<T>({
  ...
  }, [enabled, hasUnsavedContent]);

  // 3. Perform immediate save helper
        ...
        <div className="flex items-start gap-3.5">
          ...
          <div className="space-y-1">
            ...
            <h4 className="text-sm font-bold text-neutral-100">
              Anda memiliki draft {typeLabel} yang belum selesai: <span className="text-amber-300 font-mono">"{draft.title || draft.targetId}"</span>
            </h4>
            <p className="text-xs text-neutral-300">
              Pekerjaan sebelumnya tersimpan aman secara otomatis saat Anda meninggalkan halaman. Apakah Anda ingin memulihkan data draft ini?
            </p>
          </div>
        </div>
